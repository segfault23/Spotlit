...
>
  <div class="modal modal-sm">
    ...
    <div class="modal-scroll-body">
      ...
      <div class="fg">
        <label for="r-name">Name</label><input
          id="r-name"
          type="text"
      ...
      <div class="fgrow">
        <div class="fg">
          <label for="r-hp">Max HP</label><input
            id="r-hp"
            type="number"
            min="1"
            max="12"
        ...
        <div class="fg">
          <label for="r-str">Max Stress</label><input
            id="r-str"
            type="number"
            min="1"
            max="12"
      ...
      <div class="fgrow">
        <div class="fg">
          <label for="r-ev">Evasion</label><input id="r-ev" type="number" bind:value={evasion} />
        </div>
        <div class="fg">
          <label for="r-arm">Armor Score</label><input
            id="r-arm"
            type="number"
            min="0"
            max="12"
